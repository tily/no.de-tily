  ...
  (function(window, pico) {
    ...
    BasePlayer = (function() {
      ...
      BasePlayer.prototype._initialize = function(spec) {
        var calcBits, channel, duration, samplerate, slice, _ref, _ref2, _ref3, _ref4;
        ...
        duration = (_ref3 = spec.duration) != null ? _ref3 : spec.duration = 50;
        slice = (_ref4 = spec.slice) != null ? _ref4 : spec.slice = 32;
        this.SAMPLERATE = samplerate = spec.samplerate;
        this.CHANNEL = channel = spec.channel;
        calcBits = function(sec) {
          var bits, len, _ref5;
          _ref5 = [0, sec >> 1], bits = _ref5[0], len = _ref5[1];
          while (len > 0) {
            len >>= 1;
            bits += 1;
          }
    ...
    WebkitPlayer = (function() {
      ...
      function WebkitPlayer(spec) {
        ...
        console.log(this.STREAM_FULL_SIZE, 1, this.CHANNEL);
